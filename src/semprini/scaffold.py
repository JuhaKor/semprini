    ...
    def summary(self) -> tuple[str, ...]:
        ...
        lines.extend(
            [
                ...
                "now or not at all.",
                "",
                "No credentials are required yet: no sources are configured. Each source you add",
                "names an environment variable, and the workflow needs a repository secret of that",
